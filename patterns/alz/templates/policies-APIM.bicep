...
var loadPolicyDefinitions = {
  All: [
    // Used in APIM Policy Set Definition
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-BackendDuration-Alert.json')
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-Service-Capacity-Alert.json')
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-Service-FailedRequests-Alert.json')
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-Service-Requests-Alert.json')
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-Service-TotalRequests-Alert.json')
    loadTextContent('../../../services/ApiManagement/Deploy-APIM-Service-UnauthorizedRequests-Alert.json')
  ]
  AzureCloud: []
  AzureChinaCloud: []
  AzureUSGovernment: []
